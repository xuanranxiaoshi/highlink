...
public class ClearDataFlowDev {
     ...
     * 自定义 FlatMap 函数，
     */
    static class DimensionFlatMapFunction extends RichFlatMapFunction<SplitResult, ClearResult>{
        ...
        @Override
        public void flatMap(SplitResult value, Collector<ClearResult> out) throws Exception {
